export default function Logo() {
  return (
    ...
    >
      <path
        className="fill-purple transition duration-200 ease-in group-hover:fill-purple-light"
      ...
      <g mask="url(#mask0_0_1479)">
        <path
          className="fill-purple-light transition duration-200 ease-in group-hover:fill-purple"
